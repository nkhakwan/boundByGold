export class JobBoard {
  ...
  callOurFunctions(){
    this.werewolfData = this.werewolf();  
    this.goblinCaveData = this.goblinCave();
    this.caravanEscourtData = this.caravanEscourt();
    this.caravanAmbushData = this.caravanAmbush();
    this.manHunterContractData = this.manHunterContract();
    this.soldierContractData = this.soldierContract();
    this.ogreContractData = this.ogreContract();
    this.warPartyContractData = this.warPartyContract();
  };
